...
export default function Home() {
  return (
    <div className="homeMain w-screen h-screen flex flex-col items-center justify-center p-4 bg-stone-700">
      <div className="content w-full sm:w-2/3 md:w-1/2 flex flex-col items-center justify-center gap-4 md:gap-8">
